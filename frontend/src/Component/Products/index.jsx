...
const Products = () => {
  ...
  return (
    <>
      <div className=" bg-amber-50 w-[100%] min-h-[100vh] flex justify-center items-center ">
        <div className=" w-[100%] min-h-[80vh] flex flex-col justify-center items-center gap-5">
          <h1 className="text-5xl text-cyan-950 font-extrabold font-serif mt-10">
            Our Products
          </h1>
          <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {products.map((item) => (
              <div
                key={item.id}
                className="bg-white shadow-lg rounded-2xl p-2 flex flex-col items-center hover:scale-105 transition-transform"
              >
                <img
                  src={item.image}
                  alt={item.name}
